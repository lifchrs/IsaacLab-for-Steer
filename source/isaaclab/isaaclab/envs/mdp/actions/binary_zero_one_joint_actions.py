...
class BinaryZeroOneJointAction(ActionTerm):
    """Base class for binary zero one joint actions."""
    ...
    def __init__(
        self, cfg: actions_cfg.BinaryJointActionCfg, env: ManagerBasedEnv
    ) -> None:
...
class BinaryZeroOneJointPositionAction(BinaryZeroOneJointAction):
    """Binary joint action that sets the binary zero one action into joint position targets."""
