...
class DroidCanIKRelMimicEnv(ManagerBasedRLMimicEnv):
    """
    Isaac Lab Mimic environment wrapper class for Droid Can IK Rel env.
    """
    ...
    def get_subtask_term_signals(
        ...
        return {
            "grasp_can": subtask_terms["grasp_can"][env_ids],
            "can_in_oven": subtask_terms["can_in_oven"][env_ids],
        }
