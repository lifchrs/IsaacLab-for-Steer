...
class DroidWaterIKRelMimicEnv(ManagerBasedRLMimicEnv):
    """
    Isaac Lab Mimic environment wrapper class for Droid Water IK Rel env.
    """
    ...
    def get_subtask_term_signals(
        ...
        signals["move_1"] = subtask_terms["move_1"][env_ids]
        return signals
