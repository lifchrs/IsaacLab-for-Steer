...
@configclass
class DroidBlockIKRelVisuomotorMimicEnvCfg(
    DroidBlockIkRelVisuomotorEnvCfg, MimicEnvCfg
):
    """
    Isaac Lab Mimic environment config class for Droid Block IK Rel Visuomotor env.
    """
    ...
    def __post_init__(self):
        ...
        self.datagen_config.name = "isaac_lab_droid_block_ik_rel_visuomotor_D0"
