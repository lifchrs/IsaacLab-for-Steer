...
class DroidLaptopIKRelMimicEnv(ManagerBasedRLMimicEnv):
    """
    Isaac Lab Mimic environment wrapper class for Droid Laptop IK Rel env.
    """
    ...
    def get_subtask_term_signals(
        ...
        signals["laptop_grasped"] = subtask_terms["laptop_grasped"][env_ids]
        signals["laptop_placed_in_drawer"] = subtask_terms["laptop_placed_in_drawer"][env_ids]
        signals["laptop_closed"] = subtask_terms["laptop_closed"][env_ids]
        return signals
