...
class DroidScissorIKRelMimicEnv(ManagerBasedRLMimicEnv):
    """
    Isaac Lab Mimic environment wrapper class for Droid Scissor IK Rel env.
    """
    ...
    def get_subtask_term_signals(
        ...
        return {
            "grasp_scissors008": subtask_terms["grasp_scissors008"][env_ids],
            "scissors008_away_from_holder": subtask_terms["scissors008_away_from_holder"][env_ids],
            "grasp_pen": subtask_terms["grasp_pen"][env_ids],
        }
