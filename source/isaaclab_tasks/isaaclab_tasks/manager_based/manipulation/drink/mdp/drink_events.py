...
def align_attached_object_to_anchor(
    env: ManagerBasedEnv,
    env_ids: torch.Tensor | None,
    anchor_asset_cfg: SceneEntityCfg,
    attached_asset_cfg: SceneEntityCfg,
    ...
    """Place an attached object at a fixed transform relative to an anchor's current root pose."""
    if env_ids is None:
        return
    ...
    anchor_positions = anchor_asset.data.root_pos_w[env_ids]
    anchor_orientations = anchor_asset.data.root_quat_w[env_ids]
