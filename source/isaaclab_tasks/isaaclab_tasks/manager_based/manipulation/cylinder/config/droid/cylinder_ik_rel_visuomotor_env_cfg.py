...
from . import cylinder_joint_pos_visuomotor_env_cfg


@configclass
class DroidCylinderIkRelVisuomotorEnvCfg(
    cylinder_joint_pos_visuomotor_env_cfg.DroidCylinderJointPosVisuomotorEnvCfg
):
