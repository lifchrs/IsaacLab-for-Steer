...
class EventCfg:
    ...
    init_droid_arm_pose = EventTerm(
        func=franka_stack_events.set_default_joint_pose,
        mode="startup",
        params={
            "default_pose": [0.0444, -0.1894, -0.1107, -2.5148, 0.0044, 2.3775, 0.6952, 0.0, 0.0, 0.0, 0.0],
        },
    )

    randomize_droid_joint_state = EventTerm(
...
@configclass
class DroidCubeStackInstanceRandomizeEnvCfg(StackInstanceRandomizeEnvCfg):
        ...
        self.scene.ee_frame = FrameTransformerCfg(
            ...
            target_frames=[
                FrameTransformerCfg.FrameCfg(
                    prim_path="{ENV_REGEX_NS}/Robot/robotiq_85_tcp",
                    name="end_effector",
                    offset=OffsetCfg(
                        pos=[0.0, 0.0, 0.1034],
                    ),
