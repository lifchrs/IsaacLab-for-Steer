...
class EventCfg(stack_joint_pos_env_cfg.EventCfg):
    ...
    randomize_light = EventTerm(
        ...
        params={
            ...
            "default_intensity": 12000.0,
            "default_color": (0.5, 0.7, 1.0),
            "default_texture": "",
        },
    )
...
@configclass
class FrankaCubeStackVisuomotorCustomGapIDEnvCfg(stack_joint_pos_custom_env_cfg.FrankaCubeStackEnvCfg):
