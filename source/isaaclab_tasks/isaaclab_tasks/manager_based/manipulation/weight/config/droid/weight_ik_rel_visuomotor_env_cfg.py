...
from . import weight_joint_pos_visuomotor_env_cfg


@configclass
class DroidWeightIkRelVisuomotorEnvCfg(
    weight_joint_pos_visuomotor_env_cfg.DroidWeightJointPosVisuomotorEnvCfg
):
