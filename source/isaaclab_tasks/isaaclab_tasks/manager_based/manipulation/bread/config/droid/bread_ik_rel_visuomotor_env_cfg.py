...
from . import bread_joint_pos_visuomotor_env_cfg


@configclass
class DroidBreadIkRelVisuomotorEnvCfg(
    bread_joint_pos_visuomotor_env_cfg.DroidBreadJointPosVisuomotorEnvCfg
):
