...
from . import water_joint_pos_visuomotor_env_cfg


@configclass
class DroidWaterIkRelVisuomotorEnvCfg(
    water_joint_pos_visuomotor_env_cfg.DroidWaterJointPosVisuomotorEnvCfg
):
