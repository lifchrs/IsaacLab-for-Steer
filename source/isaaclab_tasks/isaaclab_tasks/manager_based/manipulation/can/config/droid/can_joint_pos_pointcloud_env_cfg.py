...
class EventCfg(BaseEventCfg):
    ...
    #     func=can_events.set_rigid_body_dynamic,
    #     mode="prestartup",
    #     params={
...
@configclass
class DroidCanJointPosPointCloudEnvCfg(CanEnvCfg):
    """Configuration for can task with Droid robot using joint position control."""
