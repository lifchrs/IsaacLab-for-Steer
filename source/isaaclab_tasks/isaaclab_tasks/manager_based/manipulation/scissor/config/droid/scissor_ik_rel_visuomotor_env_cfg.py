...
from . import scissor_joint_pos_visuomotor_env_cfg


@configclass
class DroidScissorIkRelVisuomotorEnvCfg(
    scissor_joint_pos_visuomotor_env_cfg.DroidScissorJointPosVisuomotorEnvCfg
):
