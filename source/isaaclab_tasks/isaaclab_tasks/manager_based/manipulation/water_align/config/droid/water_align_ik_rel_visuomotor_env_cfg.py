...
from . import water_align_joint_pos_visuomotor_env_cfg


@configclass
class DroidWaterAlignIkRelVisuomotorEnvCfg(
    water_align_joint_pos_visuomotor_env_cfg.DroidWaterAlignJointPosVisuomotorEnvCfg
):
