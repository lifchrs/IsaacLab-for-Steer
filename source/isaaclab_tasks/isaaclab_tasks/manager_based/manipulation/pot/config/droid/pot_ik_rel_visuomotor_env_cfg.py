...
@configclass
class DroidPotIkRelVisuomotorEnvCfg(
    ...
    def __post_init__(self):
        ...
        # self.scene.table_cam.height = 720 // 16
        # self.scene.table_cam.width = 1280 // 16
        # self.scene.wrist_cam.height = 720 // 16
        # self.scene.wrist_cam.width = 1280 // 16
