...
class ObjectTableSceneCfg(InteractiveSceneCfg):
    ...
    packing_table = AssetBaseCfg(
        ...
        spawn=UsdFileCfg(
            ...
            visual_material=PreviewSurfaceCfg(diffuse_color=(0.3, 0.3, 0.3), metallic=0.2),
        ),
    )
    ...
    object = RigidObjectCfg(
        ...
        spawn=UsdFileCfg(
            ...
            mass_props=MassPropertiesCfg(
                mass=0.3,  # Mass in kg - change this value to modify cube mass
    ...
    light = AssetBaseCfg(
        ...
        spawn=sim_utils.DomeLightCfg(color=(0.75, 0.75, 0.75), intensity=3000.0, texture_file=f""),
    )
...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        robot_pov_cam = ObsTerm(
            func=mdp.image, params={"sensor_cfg": SceneEntityCfg("robot_pov_cam"), "data_type": "rgb", "normalize": False}
        )
...
@configclass
class PickPlaceGR1T2VisuomotorCustomEnvCfg(ManagerBasedRLEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.scene.robot_pov_cam = CameraCfg(
            ...
            width=256,
            data_types=["rgb"],
            spawn=sim_utils.PinholeCameraCfg(focal_length=11.15, clipping_range=(0.1, 2)),
