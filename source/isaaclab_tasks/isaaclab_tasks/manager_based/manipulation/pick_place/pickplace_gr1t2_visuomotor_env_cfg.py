...
class ObjectTableSceneCfg(InteractiveSceneCfg):
    ...
    packing_table = AssetBaseCfg(
        ...
        spawn=UsdFileCfg(
            ...
            visual_material=PreviewSurfaceCfg(diffuse_color=(0.18, 0.18, 0.18), metallic=1.0)
        ),
    )
    ...
    light = AssetBaseCfg(
        ...
        spawn=sim_utils.DomeLightCfg(color=(0.75, 0.75, 0.75), intensity=1500.0, texture_file=f"{NVIDIA_NUCLEUS_DIR}/Assets/Skies/Cloudy/lakeside_4k.hdr",),
    )
...
@configclass
class PickPlaceGR1T2VisuomotorEnvCfg(ManagerBasedRLEnvCfg):
