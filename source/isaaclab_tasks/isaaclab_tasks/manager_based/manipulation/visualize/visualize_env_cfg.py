...
ASSET_DIR = os.path.join(
    ...
    "../../../../../../../diffusion_policy/reconstruction/asset",
)
...
@configclass
class VisualizeEnvCfg(ManagerBasedRLEnvCfg):
    """Configuration for the visualize environment."""

    # Scene settings
    scene: VisualizeSceneCfg = VisualizeSceneCfg(
