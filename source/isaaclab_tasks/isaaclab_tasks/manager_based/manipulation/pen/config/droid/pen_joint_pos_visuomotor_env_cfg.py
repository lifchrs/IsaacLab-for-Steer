...
from isaaclab_tasks.manager_based.manipulation.pen.pen_env_cfg import EventCfg as BaseEventCfg
from isaaclab_tasks.manager_based.manipulation.pen.pen_env_cfg import PEN_HOLDER001_INIT_POS
from isaaclab_tasks.manager_based.manipulation.pen.pen_env_cfg import PEN_INIT_POS
from isaaclab_tasks.manager_based.manipulation.pen.pen_env_cfg import PEN_GRASP_DIFF_THRESHOLD
from isaaclab_tasks.manager_based.manipulation.pen.pen_env_cfg import PEN_HOLDER_MAX_HEIGHT_OFFSET
from isaaclab_tasks.manager_based.manipulation.pen.pen_env_cfg import PEN_HOLDER_MIN_HEIGHT_OFFSET
from isaaclab_tasks.manager_based.manipulation.pen.pen_env_cfg import PEN_HOLDER_XY_THRESHOLD
from isaaclab_tasks.manager_based.manipulation.pen.pen_env_cfg import PenEnvCfg
...
class EventCfg(BaseEventCfg):
    ...
    remove_office_chair = EventTerm(
        func=pen_events.deactivate_prim,
        mode="prestartup",
        params={
    ...
    #     func=pen_events.set_asset_mesh_collision_to_convex_decomposition,
    #     mode="prestartup",
    #     params={
    ...
    init_franka_arm_pose = EventTerm(
        func=pen_events.set_default_joint_pose,
        mode="reset",
        params={
            "default_pose": [
                0.0,
    ...
    randomize_franka_joint_state = EventTerm(
        func=pen_events.randomize_joint_by_gaussian_offset,
        mode="reset",
        params={
            "mean": 0.0,
            "std": 0.1,
    ...
    randomize_pen_holder_pose = EventTerm(
        func=pen_events.randomize_object_pose,
        mode="reset",
        params={
            "pose_range": PEN_HOLDER_RANDOMIZE_POSE_RANGE,
            "asset_cfgs": [SceneEntityCfg("pen_holder001")],
        },
    )
...
@configclass
class DroidPenJointPosVisuomotorEnvCfg(PenEnvCfg):
    """Configuration for pen task with Droid robot using joint position control."""
